    ...
    render: function(callback) {
      var that = this,
        ...
        _tpl = [
          ...
          '<dd>',
          '<a href="javascript:;" kit-target data-options="{url:\'{{child.href}}\',icon:\'{{child.icon}}\',title:\'{{child.name}}\',id:\'{{child.id}}\'}">',
          ...
          '</dl>',
          '{{# }else{ }}',
          '<a href="javascript:;" kit-target data-options="{url:\'{{item.href}}\',icon:\'{{item.icon}}\',title:\'{{item.name}}\',id:\'{{item.id}}\'}">',
          '{{# if (item.icon.indexOf("fa-") !== -1) { }}',
          '<i class="fa {{item.icon}}" aria-hidden="true"></i>',
          '{{# } else { }}',
          '<i class="layui-icon">{{item.icon}}</i>',
