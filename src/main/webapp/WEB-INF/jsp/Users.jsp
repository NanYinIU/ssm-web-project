...
<div class="navbar navbar-default" role="navigation">
    <div class="navbar-header">
        ...
        <a class="" href="index.html"><span class="navbar-brand"><span class="fa fa-database"></span> 管理系统</span></a>
    </div>
        ...
        <ul id="main-menu" class="nav navbar-nav navbar-right">
            <li class="dropdown hidden-xs">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <span class="glyphicon glyphicon-music padding-right-small"
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li class="dropdown-header"> <shiro:hasRole name="admin"><a
                            href="/mes/AllMessageDis/1"></shiro:hasRole>管理员面板</a></li>
                    <li><a href="./">用户</a></li>
                    <li><a href="./">安全</a></li>
...
<div class="sidebar-nav">
    <ul>
        <li><a href="#" data-target=".dashboard-menu" class="nav-header" data-toggle="collapse"><i
                class="fa fa-fw fa-dashboard"></i> 面板<i class="fa fa-collapse"></i></a></li>
        <li>
        ...
        <li data-popover="true"
            ...
            rel="popover" data-placement="right"><a href="#" data-target=".premium-menu" class="nav-header collapsed"
                                                    data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i> 小功能实现<i
        ...
        <li><a href="#" data-target=".accounts-menu" class="nav-header collapsed" data-toggle="collapse"><i
                class="fa fa-fw fa-briefcase"></i> 用户信息 <span class="label label-info">+3</span></a></li>
        <li>
        ...
        <li><a href="#" data-target=".legal-menu" class="nav-header collapsed" data-toggle="collapse"><i
                class="fa fa-fw fa-legal"></i> 资源管理器<i class="fa fa-collapse"></i></a></li>
        <li>
...
<div class="content">
    ...
    <div class="main-content">
        <div class="btn-group">
            <form action="/mes/selectMsgByName/1" method="post">
                ...
                <div class="btn-toolbar list-toolbar">
                    <br>
                    <button type="submit" class="btn btn-primary"><i class="fa fa-search-plus"></i> 查询</button>
                    &nbsp;<a class="page-header"><shiro:lacksRole
                        name="admin">非管理员状态 如要对用户列表进行改删 请联系管理员</shiro:lacksRole></a>
                </div>
            </form>
        </div>
            ...
            <c:forEach var="users" items="${Users}">
                <tr>
                    ...
                    <td>
                        ...
                        <shiro:hasAnyRoles name="admin,manager"> <a href="#firstModal" role="button" data-toggle="modal"
                                                                    id="OnEdit"></shiro:hasAnyRoles><i
                            class="fa fa-edit"></i></a>
                    </td>
                    <td>
                        <shiro:hasRole name="admin"> <a href="#myModal" role="button"
                                                        data-toggle="modal"></shiro:hasRole><i
        ...
        <div class="modal small fade" id="firstModal" tabindex="-1" role="dialog" aria-labelledby="firstModalLabel"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
