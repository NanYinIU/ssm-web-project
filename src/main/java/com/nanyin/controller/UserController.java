...
public class UserController{
    ...
    public Result userLists(String search,int offset, int limit, String sort,Integer status,Integer sex) throws Exception {
        return new Result<>(userServices.findUsers(offset, limit, sort, search,status , sex));
    }
